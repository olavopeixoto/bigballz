...
namespace BigBallz.Tasks
{
    public class BonusExpirationWarningTask : ICronJobTask
    {
        ...
        public BonusExpirationWarningTask(IMailService mailService, DateTime expiration, DataContextProvider provider)
        {
        ...
        public string Name
        {
            get { return "Envio de EMail alerta Bonus não preenchido"; }
        }
        ...
        public void Run()
        {
            using (var context = _provider.CreateContext())
            {
                ...
                var startTime = context.Matches.OrderBy(x => x.StartTime).First().StartTime;
        ...
        public static void AddTask(int numberOfAlerts)
        {
            ...
            for(var i=numberOfAlerts+1 ; i > 1 ; i--)
            {
                ...
                CronJob.AddTask(new BonusExpirationWarningTask(ServiceLocator.Resolve<IMailService>(), triggerDate, ServiceLocator.Resolve<DataContextProvider>()));
            }
        }
