...
namespace BigBallz.Models
{
    public enum PagSeguroTransactionStatus
    {
        ...
        [Description("Em disputa: o comprador, dentro do prazo de liberação da transação, abriu uma disputa.")] EmDisputa = 5,
        [Description("Devolvida: o valor da transação foi devolvido para o comprador.")] Devolvida = 6,
        [Description("Cancelada: a transação foi cancelada sem ter sido finalizada.")] Cancelada = 7
    }
