    ...
    public class Check
    {
        ...
        public class Argument
        {
            ...
            public static void IsNotEmpty(Guid argument, string argumentName)
            {
                ...
                {
                    throw new ArgumentException("\"{0}\" não pode ser um Guid vazio.".FormatWith(argumentName), argumentName);
                }
            }
            ...
            public static void IsNotEmpty(string argument, string argumentName)
            {
                ...
                {
                    throw new ArgumentException("\"{0}\" não pode ser vazio.".FormatWith(argumentName), argumentName);
                }
            }
            ...
            public static void IsNotOutOfLength(string argument, int length, string argumentName)
            {
                ...
                {
                    throw new ArgumentException("\"{0}\" não pode ser mais de {1} caractere{2}.".FormatWith(argumentName, length, length > 1 ? "s" : string.Empty), argumentName);
                }
            }
            ...
            public static void IsNotEmpty<T>(ICollection<T> argument, string argumentName)
            {
                ...
                if (argument.Count == 0)
                {
                    throw new ArgumentException("Coleção não pode ser vazia.", argumentName);
                }
            }
            ...
            public static void IsNotOutOfRange(int argument, int min, int max, string argumentName)
            {
                ...
                {
                    throw new ArgumentOutOfRangeException(argumentName, "{0} deve ser entre \"{1}\"-\"{2}\".".FormatWith(argumentName, min, max));
                }
            }
            ...
            public static void IsNotInvalidEmail(string argument, string argumentName)
            {
                ...
                if (!argument.IsEmail())
                {
                    throw new ArgumentException("\"{0}\" não é um endereço de email válido.".FormatWith(argumentName), argumentName);
                }
            }
            ...
            public static void IsNotInvalidWebUrl(string argument, string argumentName)
            {
                ...
                {
                    throw new ArgumentException("\"{0}\" não é uma url válida.".FormatWith(argumentName), argumentName);
                }
            }
        }
    }
